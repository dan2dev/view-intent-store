...
export class PaginatedList<TStore extends Store<any>> extends Store<TStore> {
...
export abstract class Collection<TStore extends Store<TStore>> extends Store<TStore>  {
  ...
  constructor(store: Store<any> | undefined, type: typeof Store, idFieldName: "id" | "name" | "string" | string = "id") {
    super(store);
    this.type = type;
    this.idFieldName = idFieldName;
  }
