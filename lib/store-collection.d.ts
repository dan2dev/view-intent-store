...
export declare class PaginatedList<TStore extends Store<any>> extends Store<TStore> {
    name: string;
    ...
    getItem(id: string | number): TStore | undefined;
...
export declare abstract class Collection<TStore extends Store<TStore>> extends Store<TStore> {
    ...
    private type;
    private idFieldName;
    constructor(store: Store<any> | undefined, type: typeof Store, idFieldName?: "id" | "name" | "string" | string);
